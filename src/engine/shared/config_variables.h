...
MACRO_CONFIG_STR(Discord, discord, 128, "Discord: https://discord.gg/szCYwagvva", CFGFLAG_SERVER, "Discord")
...
MACRO_CONFIG_STR(SvRconModPassword, rcon_mod_password, 32, "", CFGFLAG_SERVER, "Remote console password for moderators (limited access)")
